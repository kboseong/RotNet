...
def efficientnet(phi, num_classes, transfer=False, block_num = False, freeze = False):
    ...
    if transfer :
        del model
        model = classifier.from_name('efficientnet-b{}'.format(phi), override_params={'num_classes': num_classes}, block_num = block_num)
